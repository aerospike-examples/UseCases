...
public class UserProfile {
    ...
    public UserProfile(String id, Date createdAt, Date updatedAt, Demographics demographics, List<String> interests,
            Location location, List<ActivityEvent> activity, List<Purchase> purchases, List<String> lineitemIds) {
        this(id, demographics, interests, location);
